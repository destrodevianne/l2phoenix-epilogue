...
public final class ServerList extends L2LoginServerPacket
{
	...
	public ServerList(L2LoginClient client)
	{
		...
		for(GameServerInfo gsi : GameServerTable.getInstance().getRegisteredGameServers().values())
		{
			...
			//{
			//	added = true;
			//	addServer("213.248.45.21", gsi.getPort(), gsi.isPvp(), gsi.isTestServer(), gsi.getCurrentPlayerCount(), gsi.getMaxPlayers(), gsi.isShowingBrackets(), gsi.isShowingClock(), gsi.getStatus(), gsi.getId());
			//}
