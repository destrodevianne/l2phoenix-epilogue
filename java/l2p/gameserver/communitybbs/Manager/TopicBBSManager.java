...
public class TopicBBSManager extends BaseBBSManager
{
	...
	{
		_table = new GArray<Topic>();
		_Maxid = new FastMap<Forum, Integer>().setShared(true);
	}
	...
	public void parsewrite(String ar1, String ar2, String ar3, String ar4, String ar5, L2Player activeChar)
	{
		if(ar1.equals("crea"))
		{
			Forum f = ForumsBBSManager.getForumByID(Integer.parseInt(ar2));
			if(f == null)
	...
	public void parsecmd(String command, L2Player activeChar)
	{
		...
		else if(command.startsWith("_bbstopics;read"))
		{
			...
			showTopics(ForumsBBSManager.getForumByID(idf), activeChar, ind, idf);
		}
		else if(command.startsWith("_bbstopics;crea"))
		{
			...
			st.nextToken();
			int idf = Integer.parseInt(st.nextToken());
			showNewTopic(ForumsBBSManager.getForumByID(idf), activeChar, idf);
		}
	...
	private void ShowMemoNewTopics(Forum forum, L2Player activeChar)
	{
		...
		html.append("<td align=center FIXWIDTH=70><button value=\"&$140;\" action=\"Write Topic crea " + forum.getID() + " Title Content Title\" back=\"L2UI_CT1.Button_DF_Small_Down\" width=65 height=20 fore=\"L2UI_CT1.Button_DF_Small\" ></td>");
	...
	private void ShowMemoTopics(Forum forum, L2Player activeChar, int index)
	{
		...
		html.append("<td align=right><button value = \"&$421;\" action=\"bypass _bbstopics;crea;" + forum.getID() + "\" back=\"L2UI_CT1.Button_DF_Small_Down\" width=65 height=20 fore=\"L2UI_CT1.Button_DF_Small\" ></td></tr>");
		html.append("<tr><td><img src=\"l2ui.mini_logo\" width=5 height=10></td></tr>");
		html.append("<tr> ");
		html.append("<td></td>");
		html.append("<td align=center><table border=0><tr><td></td><td><edit var = \"Search\" width=130 height=11></td>");
		html.append("<td><button value=\"&$420;\" action=\"Write 5 -2 0 Search _ _\" back=\"L2UI_CT1.Button_DF_Small_Down\" width=65 height=20 fore=\"L2UI_CT1.Button_DF_Small\"> </td> </tr></table> </td>");
		html.append("</tr>");
		html.append("</table>");
		html.append("<br>");
		html.append("<br>");
